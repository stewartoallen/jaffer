/* $Id: CAST128.java,v 1.2 2003/02/11 22:12:16 stewart Exp $
 *
 ...
 *
 * This class is derived from the CAST5 Cryptix code.
 */
...
//............................................................................
	...
	public void encrypt(byte in[], int inOffset, byte out[], int outOffset, int len, byte iv[])
	{
		for (int i=0; i<len; i+=8)
		{
			//blockEncrypt(in, inOffset+i, out, outOffset+i);
			for (int j=0; j<8; j++)
			{
				iv[j] ^= in[inOffset+i+j];
			}
			blockEncrypt(iv, 0, out, outOffset+i);
			System.arraycopy(out, outOffset+i, iv, 0, 8);
		}
	}

	public void decrypt(byte in[], int inOffset, byte out[], int outOffset, int len, byte iv[])
	{
		for (int i=0; i<len; i+=8)
		{
			//blockDecrypt(in, inOffset+i, out, outOffset+i);
			blockDecrypt(in, inOffset+i, out, outOffset+i);
			for (int j=0; j<8; j++)
			{
				out[outOffset+i+j] ^= iv[j];
			}
			System.arraycopy(in, inOffset+i, iv, 0, 8);
		}
	}
...
//............................................................................
    ...
    {
        if (userkey == null)
            throw new RuntimeException("Null user key");
